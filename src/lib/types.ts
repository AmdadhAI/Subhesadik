...
/**
 * Responsive image URLs for hero images
 * Generated by Cloud Function in 3 sizes for optimal loading
 */
...
export interface HeroSlide {
  ...
  title: string;
  subtitle: string;
  imageUrls?: HeroImageUrls;  // New: responsive image URLs
  imageUrl?: string;           // Deprecated: fallback for old images
  imageHint?: string;
  ctaText: string;
  ctaLink: string;
  isActive: boolean;
...
export interface SiteContent {
  ...
  heroTitle?: string;
  heroSubtitle?: string;
  heroImageUrls?: HeroImageUrls;  // New: responsive URLs
  heroImageUrl?: string;           // Deprecated: fallback
  heroCtaText?: string;
  heroCtaLink?: string;
